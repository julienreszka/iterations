...
<script>
  export default {
    ...
    beforeMount(){
      this.numWidth = this.getVH() * 80/100;
    },
    mounted() {
      this.setup()
      ...
      // TODO detect mouseout
      // https://stackoverflow.com/questions/7977806/detect-mousemove-out-event-for-html-canvas-element

      this.canvas.addEventListener('mouseup', () => {
          console.log("mouseup")
          var newImageData = this.ctx.getImageData(0,0, this.numWidth,this.numWidth)
